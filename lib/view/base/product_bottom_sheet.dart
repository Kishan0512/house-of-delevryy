...
import 'package:efood_multivendor/view/screens/subscription/subscription_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GetBuilder<ProductController>(builder: (productController) {
        ...
        print('IMAGE uRL --------');
        print('${widget.isCampaign ? Get.find<SplashController>().configModel.baseUrls.campaignImageUrl
